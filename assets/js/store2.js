!(function (a, b) {
  var c = {
      ...
      stringify: function (a) {
        return void 0 === a || "function" == typeof a
          ? a + ""
          : JSON.stringify(a);
      },
      parse: function (a, b) {
      ...
      Store: function (a, b, d) {
        ...
        e._id = a;
        try {
          b.setItem("_-bad-_", "wolf"), (e._area = b), b.removeItem("_-bad-_");
        } catch (a) {}
        return (
          e._area || (e._area = c.storage("fake")),
          (e._ns = d || ""),
          c.areas[a] || (c.areas[a] = e._area),
          c.apis[e._ns + e._id] || (c.apis[e._ns + e._id] = e),
          e
        );
      },
      storeAPI: {
        area: function (a, b) {
          ...
          return (
            (d && d.area) ||
              ((d = c.Store(a, b, this._ns)), this[a] || (this[a] = d)),
            d
          );
        },
        namespace: function (a, b) {
          ...
          if (
            !(
              (e && e.namespace) ||
              ((e = c.Store(this._id, this._area, this._ns + d + ".")),
              this[d] || (this[d] = e),
              b)
            )
          )
            for (var f in c.areas) e.area(f, c.areas[f]);
          return e;
        },
        isFake: function () {
        ...
        has: function (a) {
          return this._area.has
            ? this._area.has(this._in(a))
            : !!(this._in(a) in this._area);
        },
        size: function () {
        ...
        get: function (a, b) {
          var d,
            e = c.get(this._area, this._in(a));
          return (
            "function" == typeof b && ((d = b), (b = null)),
            null !== e ? c.parse(e, d) : null != b ? b : e
          );
        },
        getAll: function (a) {
          return this.each(function (a, b, c) {
        ...
        set: function (a, b, d) {
          ...
          return null != e && !1 === d
            ? b
            : c.set(this._area, this._in(a), c.stringify(b), d) || e;
        },
        setAll: function (a, b) {
          var c, d;
        ...
        add: function (a, b) {
          var d = this.get(a);
          if (d instanceof Array) b = d.concat(b);
          else if (null !== d) {
            var e = typeof d;
          ...
          return c.set(this._area, this._in(a), c.stringify(b)), b;
        },
        remove: function (a, b) {
          var d = this.get(a, b);
        ...
        clearAll: function () {
          ...
          for (var b in c.areas)
            c.areas.hasOwnProperty(b) &&
              ((this._area = c.areas[b]), this.clear());
          return (this._area = a), this;
        },
        _in: function (a) {
          return (
            "string" != typeof a && (a = c.stringify(a)),
            this._ns ? this._ns + a : a
          );
        },
        _out: function (a) {
          return this._ns
            ? a && 0 === a.indexOf(this._ns)
              ? a.substring(this._ns.length)
              : void 0
            : a;
        },
      },
  ...
  (d.local = d),
    ...
    d.area("page", c.storage("page")),
    "function" == typeof b && void 0 !== b.amd
      ? b("store2", [], function () {
          return d;
        })
      : "undefined" != typeof module && module.exports
      ? (module.exports = d)
      : (a.store && (c.conflict = a.store), (a.store = d));
